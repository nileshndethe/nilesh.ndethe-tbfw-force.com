...
declare module "@salesforce/schema/Contact.Formatted_Address__c" {
  const Formatted_Address__c:string;
  export default Formatted_Address__c;
}
declare module "@salesforce/schema/Contact.Photo_URL__c" {
  const Photo_URL__c:string;
  export default Photo_URL__c;
}
declare module "@salesforce/schema/Contact.Photo__c" {
  const Photo__c:string;
  export default Photo__c;
}
declare module "@salesforce/schema/Contact.Profile__c" {
  const Profile__c:string;
  export default Profile__c;
}
declare module "@salesforce/schema/Contact.Total_Trailhead_Badges__c" {
  const Total_Trailhead_Badges__c:string;
  export default Total_Trailhead_Badges__c;
}
declare module "@salesforce/schema/Contact.UID__c" {
  const UID__c:number;
  export default UID__c;
}
