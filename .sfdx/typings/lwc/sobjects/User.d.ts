...
declare module "@salesforce/schema/User.agf__External_ID__c" {
  const agf__External_ID__c:string;
  export default agf__External_ID__c;
}
declare module "@salesforce/schema/User.agf__GUS_User_Type__c" {
  const agf__GUS_User_Type__c:string;
  export default agf__GUS_User_Type__c;
}
declare module "@salesforce/schema/User.agf__Notification_Level__c" {
  const agf__Notification_Level__c:string;
  export default agf__Notification_Level__c;
}
declare module "@salesforce/schema/User.agf__Show_All_Work_Comments__c" {
  const agf__Show_All_Work_Comments__c:boolean;
  export default agf__Show_All_Work_Comments__c;
}
declare module "@salesforce/schema/User.agf__Summary__c" {
  const agf__Summary__c:string;
  export default agf__Summary__c;
}
declare module "@salesforce/schema/User.agf__Team_Member_Allocation__c" {
  const agf__Team_Member_Allocation__c:string;
  export default agf__Team_Member_Allocation__c;
}
declare module "@salesforce/schema/User.agf__Wall_Preference__c" {
  const agf__Wall_Preference__c:string;
  export default agf__Wall_Preference__c;
}
declare module "@salesforce/schema/User.agf__Work_User_Interface__c" {
  const agf__Work_User_Interface__c:string;
  export default agf__Work_User_Interface__c;
}
