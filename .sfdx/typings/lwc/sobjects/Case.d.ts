...
declare module "@salesforce/schema/Case.agf__ADM_Work__r" {
  const agf__ADM_Work__r:any;
  export default agf__ADM_Work__r;
}
declare module "@salesforce/schema/Case.agf__ADM_Work__c" {
  const agf__ADM_Work__c:any;
  export default agf__ADM_Work__c;
}
